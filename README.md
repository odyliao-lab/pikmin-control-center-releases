...
目前最新 0.8.1：更新檢查、公開下載、簽章／損壞檔案拒絕、取消下載及 GPS 互斥已完成 Android 14 實測。2026-09-08 已完成使用者確認系統安裝與17項升級後檢查：正式APK與公開SHA一致、再次檢查為最新版、安裝鎖解除、現有設定及紀錄保留。其他 OEM／Android 版本尚未全面驗證。
